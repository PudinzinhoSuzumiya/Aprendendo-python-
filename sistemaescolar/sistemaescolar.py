    ...
    while True:
        ...
        if opcao == '1':
            ...
            while True:
                ...
                if qtd_notas_str.isdigit():
                    qtd_notas = int(qtd_notas_str)
                    break
                else:
            ...
            if len(alunos) == 0:
                ...
                for aluno in alunos:
                    notasarredondas = calcular_media(aluno)
            ...
            if len(alunos) >= 1:
                maiormedia = max(alunos, key=lambda a: calcular_media(a))
                menormedia = min(alunos, key=lambda aluno: calcular_media(aluno))
            ...
            for i,aluno in enumerate(alunos):
                if aluno['matricula'] == matriculaeditar:
                    ...
                    if opcao == '1':
                        ...
                        while True:
                            qtd_notas_str = input("Quantas notas deseja cadastrar: ")
                            if qtd_notas_str.isdigit():
                                qtd_notas = int(qtd_notas_str)
                                break
                            else:
            ...
            for i,aluno in enumerate(alunos):
                if aluno['matricula'] == remover_matricula:
                    ...
                    print(f"Notas: {aluno['notas']}")
                    print(f"Média: {calcular_media(aluno)}")
                    escolha = input("Tem certeza que deseja remover esse aluno? (s/n): ").strip().lower()
                    if escolha == 's':
                        del alunos[i]
                        salvar_dados(alunos)
